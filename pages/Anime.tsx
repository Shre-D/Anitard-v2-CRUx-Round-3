...
import ShowcaseAnime from "../components/ShowcaseAnime";
import AnimeCarousel from "../components/AnimeCarousel";
import { useState, useEffect } from "react";

export default function Animepage() {
  const [topAnime, setTopAnime] = useState([]);
  const [animeDisplay, setAnimeDisplay] = useState([]);
    ...
    (
      <div>
        ...
        {loading ? (
          ...
          <div>
            <ShowcaseAnime animeData={animeDisplay} />
            <AnimeCarousel topAnime={topAnime} seasonalAnime={animeDisplay} />
          </div>
        )}
      </div>
    )
